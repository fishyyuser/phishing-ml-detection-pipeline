...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig()):
        ...
        self.data_transformation_dir:str = os.path.join(
            training_pipeline_config.artifact_dir,
            training_pipeline_config.DATA_TRANSFORMATION_DIR_NAME
        )

        self.transformed_train_file_path:str = os.path.join(
            self.data_transformation_dir,
            training_pipeline_config.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
        ...
        self.transformed_test_file_path:str = os.path.join(
            self.data_transformation_dir,
            training_pipeline_config.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            training_pipeline_config.DATA_TRANSFORMATION_TEST_FILE_PATH
        )

        self.transformed_object_file_path:str = os.path.join(
            self.data_transformation_dir,
            training_pipeline_config.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,
            training_pipeline_config.PREPROCESSING_OBJECT_FILE_NAME
        )
